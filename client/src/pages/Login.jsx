  ...
  return (
    <section className='w-full container   bg-green-50 mx-auto h-screen  '>
        <div className='sticky top-20 '>
            <div className=' bg-green-100 lg:w-130 w-80 p-7 mx-auto  shadow-md  rounded  border border-green-200'>
           ...
           <p className='text-black py-3 font-bold'>LandLlord/Tenant Login</p>
           <form action="" onSubmit={handleSubmit}>
           
            
            <div className='grid py-2  ml-3'>
            <label htmlFor="" className='text-black font-semibold'>Phone:</label>
            <div className=' bg-green-100 border-green-100 border-b-green-400'>
                <input type="tel" 
            id='phone'
             name="phone"
            ...
            className='border border-green-100 w-full outline-none border-b-green-400'
            />
            </div>
            ...
            <div className=' bg-green-100 border-green-100 border-b-green-400 outline-none border rounded flex items-center justify-between gap-2 '>
