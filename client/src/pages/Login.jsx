...
const Login = () => {
  ...
  return (
    <section className='w-full container mt-20 mx-auto  '>
        <div className='bg-white  lg:w-130 w-80  p-7 mx-auto shadow-md  rounded  border border-green-400'>
           
           <p className='bg-red-300 w-full   text-red-600 p-2 rounded font-semibold '>No Account!!! Register With your Landlord</p>
           <img src={logo} alt="" width={120} height={120} className='items-center ml-30 lg:ml-40 flex justify-center' />
